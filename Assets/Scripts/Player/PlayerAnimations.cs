    ...
    public class PlayerAnimations : MonoBehaviour
    {
        ...
        private void SetupKnifeSprites()
        {
            ...
            if (knifeAnimator == null)
            {
                ...
                knifeAnimation =
                    Resources.Load("PlayerWeapons/knife/Sprites/shooting_AnimController") as RuntimeAnimatorController;
            }
        ...
        private void SetupPistolSprites()
        {
            ...
            if (pistolAnimator == null)
            {
                ...
                pistolReloadAnimation =
                    Resources.Load("PlayerWeapons/pistol/Sprites/reload_AnimController") as RuntimeAnimatorController;
            }
        ...
        private void SetupSmgSprites()
        {
            ...
            if (smgAnimator == null)
            {
                ...
                smgReloadAnimation =
                    Resources.Load("PlayerWeapons/smg/Sprites/reload_AnimController") as RuntimeAnimatorController;
            }
